...
I like what the name stands for — expertise across the whole lifecycle of financial models — but "full stack" is used too rarely in the finance industry for the title to translate on its own. A course title shows up on a transcript and a résumé, and a recruiter reading it should be able to tell, without any explanation, what the student learned. "Full Stack Quantitative Finance" needed a paragraph of explanation, and a transcript line doesn't get a paragraph.

## Why not return to "Data Science Tools for Finance"?

I was always fond of the original title. But the Core Programming sequence already includes a course with "data science" in its title, *Python for Financial Data Science*, and colleagues in the program raised the same overlap concern I had. There is real overlap in the tooling the two courses touch, so the rename is also an opportunity to draw the distinction more clearly: that course builds fluency in Python and the core data-science toolkit; this course assumes intermediate Python and concentrates on the pipeline around the data.

## Names considered

| Name | Assessment |
|---|---|
| *Data Science Tools for Finance* (original name) | Accurate, and I still like it. But it shares "data science" with the sibling core course *Python for Financial Data Science*, and "tools" describes the parts list rather than what students build with it. |
| *Full Stack Quantitative Finance* (previous name) | Describes the ambition well, but "full stack" is used too rarely in the finance industry to translate on a transcript. It requires explanation before it means anything. |
